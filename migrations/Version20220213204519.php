 ...
 */
final class Version20220213204519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD booker_fullname VARCHAR(255) NOT NULL, ADD booker_email VARCHAR(255) NOT NULL, ADD booker_phone INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE booking DROP booker_fullname, DROP booker_email, DROP booker_phone, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
