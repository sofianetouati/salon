 ...
 */
final class Version20220324153133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rest (id INT AUTO_INCREMENT NOT NULL, coiffeur_id INT DEFAULT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, INDEX IDX_FD1421D0BD427C57 (coiffeur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE rest ADD CONSTRAINT FK_FD1421D0BD427C57 FOREIGN KEY (coiffeur_id) REFERENCES coiffeur (id)');
    }
