 ...
 */
final class Version20220302180738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE product_detail product_detail VARCHAR(255) DEFAULT NULL');
    }
