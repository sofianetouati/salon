Dashmix.onLoad(
  class {
    static initCorporateChartJS() {
      ...
      let t,
        e,
        a = document.getElementById("js-chartjs-corporate-slim-projects"),
        r = document.getElementById("js-chartjs-corporate-slim-tickets");
      null !== a &&
        (t = new Chart(a, {
          type: "line",
          data: {
          ...
          options: {
            tension: 0.4,
            scales: { y: { suggestedMin: 0, suggestedMax: 22 } },
            interaction: { intersect: !1 },
            plugins: {
              tooltip: {
                callbacks: {
                  label: function (t) {
                    return " " + t.parsed.y + " Sales";
                  },
                },
              },
            },
