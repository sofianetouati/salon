  ...
  class {
    static initChartsChartJS() {
      ...
      (n = {
        ...
        null !== i && (t = new Chart(i, { type: "bar", data: n })),
        null !== h && (e = new Chart(h, { type: "radar", data: n })),
        null !== u && (r = new Chart(u, { type: "polarArea", data: d })),
        null !== c && (o = new Chart(c, { type: "pie", data: d })),
